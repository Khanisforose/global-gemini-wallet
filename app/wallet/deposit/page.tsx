...
const A:Record<string,string>={"BTC":"14J6KfQzXyLV8gLUKMWch2S3hjJvkMy5Rc","USDT-ERC20":"0xa7b97439665f545adb3bbc431ceb5053d4b46f49","USDT-BEP20":"0xa7b97439665f545adb3bbc431ceb5053d4b46f49","USDT-TRC20":"TLgjfeg8Mqw5ueo1CGC8eTb4EHysPMMA6S","SOL":"FQy4HArVdBbZ87AHrbfdhSXRgyE5NUbrh6GaL8enMUeh","ETH":"0x09B0E6D01fb1DeDf172933cC1673aAf460353AAD"}
...
<div style={{background:"rgba(255,215,0,0.06)",border:"1px solid rgba(255,215,0,0.15)",borderRadius:12,padding:16,marginBottom:16,wordBreak:"break-all",fontSize:12,fontFamily:"monospace",color:"#FFD700"}}>{(A as any)[as]||"N/A"}</div>
